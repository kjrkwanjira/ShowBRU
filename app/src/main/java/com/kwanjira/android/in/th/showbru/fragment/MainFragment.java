    ...
    private void loginController() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText uerEditText = getView().findViewById(R.id.adtUser);
                EditText passwordEditText = getView().findViewById(R.id.edtPassword);

                String userString = uerEditText.getText().toString().trim();
...
//                Replace Freagment
                getActivity().getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.contenMainFragment, new RegisterFragment())
                        .addToBackStack(null)
                        .commit();
            }
        });
